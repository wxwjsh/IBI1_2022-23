...
for term_element in term_elements:
    ...
    if 'autophagosome' in defstr_element.firstChild.data:
        ...
        num_of_child_nodes = count_child_nodes(go_id)
        ...
        sheet.cell(row=row_index, column=4).value = num_of_child_nodes
        row_index += 1

#save the sheet
excel_file_path = r'/Users/jishuhan/Desktop\IBIcode.xlsx'
